...
const techStacks = {
  ...
  libraries: [
    ...
    {
      name: "Inertia",
      logo: "https://cdn.jsdelivr.net/npm/simple-icons@14.11.0/icons/inertia.svg",
    },
    {
      name: "p5.js",
...
const LogoStream = ({
  ...
  return (
    <Box overflowX="hidden" position="relative" h="80px" w="100%" py="10px">
      <MotionFlex
        animate={{
          x: direction === "left" ? [-totalWidth, 0] : [totalWidth, 0],
        }}
        transition={{
          duration: speed,
          repeat: Infinity,
...
const BioHeader = () => {
  ...
  return (
    <Box textAlign="center" mb={16} position="relative">
      ...
      {/* Main Greeting */}
      <MotionFlex justify="left" align="center" gap={4} mb={6} wrap="wrap">
